...
export default function CreateOrphanage() {
  ...
  function handleSelecImages(e: ChangeEvent<HTMLInputElement>) {
                ...
                {previewImages.map((image, index) => (
                  <div className="image-preview-container">
                    ...
                    <button type="button" className="remove" onClick={() => {
                      setImages(oldImages => oldImages.filter((_, oldImageIndex) => oldImageIndex !== index));
                      setPreviewImages(oldImages => oldImages.filter((_, oldImageIndex) => oldImageIndex !== index));
                    }}>
